...
const facultyCredential = require("../../models/Faculty/FacultyCredentials");
...
router.delete("/deleteDetails/:id", async (req, res) => {
  try {
    ...
    // Also delete the credentials
    await facultyCredential.findOneAndDelete({ loginid: user.employeeId });
    const data = {
      success: true,
